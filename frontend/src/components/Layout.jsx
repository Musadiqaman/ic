  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <div className="flex">
        ...
        {/* Main */}
        <div className={`flex-1 min-h-screen transition-all duration-300 ${collapsed ? "md:ml-16" : "md:ml-44"}`}>
          <header
            className="sticky top-0 z-20 flex items-center gap-2 md:gap-4 border-b px-3 md:px-5 py-3 backdrop-blur-xl"
          ...
          >
            ...
            <button
              ...
              disabled={loggingOut}
              title="Logout"
              className="p-1.5 md:p-2 rounded-lg border transition-all shrink-0 disabled:opacity-60"
